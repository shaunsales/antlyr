  ...
  return (
    <div className="border-b border-gray-800">
      <button
        ...
        className="flex w-full items-center justify-between px-4 py-3 text-left hover:bg-gray-800/30"
      >
        <div>
          <h2 className="text-sm font-semibold text-gray-200">Run Backtest</h2>
          <p className="text-xs text-gray-500">Configure and execute</p>
        </div>
        {expanded ? (
